...
TreemaNode = (function() {
  ...
  TreemaNode.prototype.addChildTemplate = '<div class="treema-add-child" style="display:none;" tabindex="9009">&nbsp;</div>';
...
TreemaNode.prototype.getCallback = function() {
  ...
  TreemaNode.prototype.createTypeSelector = function() {
    ...
    select = $('<select></select>').addClass('treema-type-select').css("display", "none");
  ...
  TreemaNode.prototype.flushChanges = function() {
    ...
    //this.onEditInputBlurUpdate(_results[0].$el.attr("id")+"_editor", _results[0].getData());
    //this.onEditInputBlurUpdate(_results[0].$el.attr("id"), _results[0].getData());
    if(typeof _results[0] == "undefined") {
      this.onEditInputBlurUpdate(this.parent.$el.attr("id"), this.parent.getData());
    } else {
      this.onEditInputBlurUpdate(_results[0].$el.attr("id"), _results[0].getData());
    }
  ...
  TreemaNode.prototype.onEditInputBlurUpdate = function(currentID, data) {
      currentID = currentID.replace("_editor", "");
      $("#"+currentID).val(JSON.stringify(data, null, 2));
  }
